 ...
 */
public class HomeHttpRequest extends BaseHttpRequest<AppList> {
    ...
    public AppList processJson(String str) {
        ...
        try {
            ...
            JSONArray picture = json.getJSONArray("picture");
            for (int i = 0; i < picture.length(); i++) {
                String pictureString = picture.getString(i);
                appList.picture.add(pictureString);
            }
