...
import appstore.keivn.jf.kevinstore.http.httputils.GameHttpRequest;
...
public class GameFragment extends BaseFragment {
    ...
    public Loadingpage.StateCode fragmentRequestDate() {
        GameHttpRequest http = new GameHttpRequest();
    ...
    private ArrayList<AppList.AppInfo> loadMOre() {
        ...
        GameHttpRequest homeHttp = new GameHttpRequest();
